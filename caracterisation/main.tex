...
\section{Lexique}
% notion statiques du système
% objets minimaux (flux, noeud, message)
% synchrone : pas obligé de transmettre un pour un
% file d'attente = n'existe pas, noeud spécialisé, idem cannaux
% rédéfinir sur-type, curryfication, plusieurs flux
